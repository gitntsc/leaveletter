...
?>
                  ...
                  <div class="card-header py-3">
                    ...
                    <table class="table table-striped table-hover table-bordered">
                          ...
                          while ($objResult11= mysqli_fetch_assoc($objQuery11))
                          {
                            ...
                            $vacationword = " $day วัน หรือ $hour ชั่วโมง $minute นาที ";
  ...
  <table class="table table-striped table-hover table-bordered">
    ...
    <?php
       include "connect.php";
      $strSQL2 = "SELECT * FROM leave_tbl Where status = 'non approve' and username !='' order by ".$col." ".$strNewOrder."";
       //echo
    ...
    while ($objResult2= mysqli_fetch_assoc($objQuery2))
    {
      ...
      $strSQL5 = "SELECT * FROM member where username = '".$_POST['username']."' and username !=''";
    ...
    <tbody>
      ...
      <form name="1" method="post" action="save_approve.php?leave_id=<?php echo $objResult2["leave_id"];?>">
        ...
        <td><?php echo $objResult2['strdate']."<br>";echo $objResult2['strtime'];?></td>

        <td><?php echo $objResult2['lastdate']."<br>";echo $objResult2['lasttime'];?></td>
...
<?php
  ...
  <?php
  include "connect.php";
  $strSQL2 = "SELECT * FROM leave_tbl Where status = 'non approve' and username = '".$_POST['forname']."' and username !='' order by ".$col." ".$strNewOrder."";
 //echo
   $objQuery2 = mysqli_query($objCon,$strSQL2);
  ...
  while ($objResult2= mysqli_fetch_assoc($objQuery2))
  {
   ...
   $strSQL5 = "SELECT * FROM member where username = '".$_POST['username']."' and username !='' order by ".$cols." ".$strNewOrder."";
    $objQuery5 = mysqli_query($objCon,$strSQL5);
    $objResult5 = mysqli_fetch_array($objQuery5,MYSQLI_ASSOC);

    echo $objResult5['sicktime'];
    ?>
...
<?php
  ...
  <?php
    include "connect.php";
    $strSQL2 = "SELECT * FROM leave_tbl Where status = 'non approve' and strdate between '".$_POST['strdate']."' and '".$_POST['lastdate']."' and username !='' order by ".$col." ".$strNewOrder."";
   //echo
     $objQuery2 = mysqli_query($objCon,$strSQL2);
  while ($objResult2= mysqli_fetch_assoc($objQuery2))
  {
...
<?php
  ...
  <?php
    $strSQL2 = "SELECT * FROM leave_tbl WHERE strdate between '".$_POST['strdate']."' and  '".$_POST['lastdate']."' and status = 'non approve' order by ".$col." ".$strNewOrder."";
    $objQuery2 = mysqli_query($objCon,$strSQL2);
