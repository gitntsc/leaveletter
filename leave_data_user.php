...
if($_SESSION['level'] !== 'hr'){
              echo "<script>alert='Wrong Permission';</script>";
              header("location:index.php");
}
          ...
          <div class="row">
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-12">
                ...
                <form name="1" method="post" action="save_leave_data_user.php">
                <div class="card shadow mb-12">
                  <div class="card-header py-3">
                    <div class="col-md-12">
                    <div class="col-md-3">
                          <input class="form-control" type="text" name="username" id="username" placeholder="ใส่ ID เท่านั้น ตัวอย่างเช่น wirin"><br> 
                </div>      
                      ...
                      <div class="radio disabled">
                        <label><input type="radio" name="leave" id="leave" value="ลาบวช">ลาบวช</label>
                      </div>
