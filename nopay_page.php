...
?>
  ...
  <table class="table table-striped table-hover table-bordered">
    ...
    include "connect.php";
  $strSQL2 = "SELECT * FROM leave_tbl Where kind_leave = 'ลากิจไม่รับค่าจ้าง' and status = 'approve'";
  //echo
...
<?php
  ...
  $strSQL2 = "SELECT * FROM leave_tbl WHERE strdate between '".$_POST['strdate']."' and  '".$_POST['lastdate']."' and kind_leave = 'ลากิจไม่รับค่าจ้าง' and status = 'approve'";
  $objQuery2 = mysqli_query($objCon,$strSQL2);
