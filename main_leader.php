    ...
    <li class="nav-item">
      ...
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="edit_page_u.php">แก้ไขข้อมูลการลาของตัวเอง</a>


        </div>
    </li>
    <li class="nav-item">
      <a class="nav-link collapsed" href="approve_page.php" data-toggle="collapse" data-target="#test2" aria-expanded="true" aria-controls="collapseTwo">
        <i class="fas fa-fw fa-cog"></i>
        <span>อนุมัติการลา</span>
      </a>
      <div id="test2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">

         <a class="collapse-item" href="approve_under.php">อนุมัติการลา</a>

        </div>
    </li>

    <?php
if($_SESSION['username']=='Panaree')
{
     ?>
     <li class="nav-item">
       ...
       <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
         <div class="bg-white py-2 collapse-inner rounded">
           ...
           <a class="collapse-item" href="history_leave.php">ดูข้อมูลการลาย้อนหลังตัวเอง</a>
           <a class="collapse-item" href="report_year_leader.php">ดูข้อมูลการแบบปี</a>
           <a class="collapse-item" href="nopay_page.php">ลาไม่รับค่าจ้าง</a>
 ...
 <li class="nav-item">
   ...
   <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
     <div class="bg-white py-2 collapse-inner rounded">
       ...
       <a class="collapse-item" href="history_leave.php">ดูข้อมูลการลาย้อนหลังตัวเอง</a>
       <a class="collapse-item" href="report_year_leader.php">ดูข้อมูลการแบบปี</a>
       <a class="collapse-item" href="nopay_u_page.php">ลาไม่รับค่าจ้างของตัวเอง</a>
