...
<?php
 ...
 ?>
  ...
  <table class="table table-striped table-hover table-bordered">
    ...
    date_default_timezone_set("Asia/Bangkok");
    	$time2 = date('Y-m-d');
      $years = date("Y",strtotime($time2));
      $year = $_POST['selectyear'];

    if($year==""){
    include "connect.php";
    $strSQL2 = "SELECT * FROM leave_tbl WHERE strdate like '%$years%'";
 ...
 <?php
   ...
   $strSQL2 = "SELECT * FROM leave_tbl  WHERE strdate like '%$year%'";
   $objQuery2 = mysqli_query($objCon,$strSQL2);
   ...
   <tbody>
     ...
     <form name="1" method="post" action="save_approve.php?leave_id=<?php echo $objResult2["leave_id"];?>">
       ...
       <td><?php echo $objResult2['summary_time'];?>ชั่วโมง</td>
