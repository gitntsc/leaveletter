    ...
    <li class="nav-item">
      ...
      <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="nopay_page.php">ดูข้อมูลการแบบปี</a>
          <a class="collapse-item" href="edit_page_u.php">ลาไม่รับค่าจ้าง</a>
          <a class="collapse-item" href="edit_page_u.php">ดูข้อมูลการลาไม่รับค่าจ้างตัวเอง</a>
