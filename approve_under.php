         ...
         <div class="card-header py-3">
           <div class="col-md-12">
             ...
             <div class="container">
               ...
               <?php
            $strSQL10 = "SELECT * FROM member where leader1 = '".$_SESSION['username']."' or leader2 = '".$_SESSION['username']."' order by username asc";
...
include "connect.php";
 $strSQL2 = "SELECT * FROM leave_tbl where (leader1 = '".$_SESSION['username']."' or leader2 = '".$_SESSION['username']."')  and status = 'non approve'";
...
<tr>
   ...
   <th style="width:15%">การอนุมัติ</th>
...
<td><label><?php echo $objResult2['crt_time'];?></label></td>
<td>	<div class="form-group">

<select class="form-control" id="approve" name="approve">
<option value="approve">อนุมัติ</option>
<option value="cancle">ไม่อนุมัติ</option>
...
include "connect.php";
 $strSQL2 = "SELECT * FROM leave_tbl Where username = '".$_POST['forname']."' and (leader1 = '".$_SESSION['username']."' or leader2 = '".$_SESSION['username']."') and status = 'non approve'";
...
<?php
 ...
 $strSQL2 = "SELECT * FROM leave_tbl WHERE username = '".$_POST['forname']."' and (leader1 = '".$_SESSION['username']."' or leader2 = '".$_SESSION['username']."') and strdate between '".$_POST['strdate']."' and  '".$_POST['lastdate']."'
and status = 'non approve' ";
$objQuery2 = mysqli_query($objCon,$strSQL2);
