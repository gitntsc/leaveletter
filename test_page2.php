                                                                    ...
                                                                    echo    $day4;
																		if($time3>$day4)
																		{
																			if($objResult10['kind_work']=="office"){
																				...
																				$objQuery11 = mysqli_query($objCon,$strSQL11);
																				//$strSQL21 = "UPDATE member SET ct2 = '0' WHERE username = '".$_SESSION['username']."'";
																				//$objQuery21 = mysqli_query($objCon,$strSQL21);
																		}
																			}else{
																				if($ct2=="1"){
															...
															$time3 = date('Y-m-d');
																	...
																	if($time3>$day4)
																	{
																		if($objResult10['kind_work']=="office"){
																			...
																			$exvacation_time =  $objResult10['exvacation_time']+61200;
																			$vacation_time = $objResult10['vacation_time']+61200;
																			$strSQL11 = "UPDATE member SET exvacation_time = '".$exvacation_time."',vacation_time = '".$vacation_time."'  where username = '".$_SESSION['username']."'";
																			$objQuery11 = mysqli_query($objCon,$strSQL11);
