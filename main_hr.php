  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
      ...
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="edit_page.php">แก้ไขข้อมูล</a>
    ...
    <li class="nav-item">
      ...
      <div id="test2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        ...
        <a class="collapse-item" href="approve_page.php">อนุมัติการลา</a>
    ...
    <li class="nav-item">
      ...
      <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <div class="collapse-divider">การอนุมัติ</div>

          <a class="collapse-item" href="cancle_page.php">ยกเลิกคำขอลาที่อนุมัติแล้ว</a>
  ...
  if($_SESSION['level'] == 'admin'){
    ...
    <?php
     ...
     <?php
      ...
      ?>
      <li class="nav-item">
        <a class="nav-link" href="hr_page.php">
          <i class="fas fa-fw fa-table"></i>
          <span>ใบคำร้องขอลา</span></a>
      </li>
      <?php
