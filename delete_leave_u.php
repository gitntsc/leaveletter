...
?>
  ...
  <table class="table table-striped table-hover table-bordered">
    ...
    <?php
    include "connect.php";
    echo $strSQL2 = "SELECT * FROM leave_tbl WHERE username = '".$_SESSION['username']."' and status = 'non approve'";
    ...
    <tbody>
      ...
      <td align="center"><a href="save_delete_leave.php?leave_id=<?php echo $objResult2["leave_id"];?>" onclick="return confirm('คุณต้องการลบหรือไม่')">Delete</a></td>
