...
?>
<?php
  $strSQL10 = "SELECT * FROM member WHERE leader1 = '".$_SESSION['username']."' or leader2 = '".$_SESSION['username']."'";
 ...
 ?>
         ...
         <div class="row">
            ...
            <div class="col-xl-12 col-lg-6">
              <div class="card shadow mb-12">
                ...
                <center>  <h6 class="m-0 font-weight-bold text-primary">คำขอลาตามปีต่างๆ</h6></center>
                </div>
                  ...
                  <div class="card-header py-3">
                    <div class="col-md-12">
                      ...
                      <form name="frmSearch" method="post" action="<?=$_SERVER['SCRIPT_NAME'];?>">
                        <center><label>ปี ค.ศ</label>
                        <div class="col-4">
                          <h4>ใส่เป็น ค.ศ.เท่านั้น</h4>
                          <input class="form-control" type="text" name="selectyear" id="selectyear">
                        </div></center>
                        <br>
                        <?php
                        $strSQL11 = "SELECT * FROM member where leader1 = '".$_SESSION['username']."' or leader2 = '".$_SESSION['username']."' or username = '".$_SESSION['username']."' order by username asc";
                        $objQuery11 = mysqli_query($objCon,$strSQL11);

                        ?>
                        <center><div class="col-4">
                          <h4>ผู้ใต้บังคับบัญชา</h4>
                          <select name="forname" id="forname" class="form-control">
                          <option value="">-</option>

                            <?php while($objResult11 = mysqli_fetch_assoc($objQuery11)): ?>
                          <option value="<?=$objResult11['username']?>"><?=$objResult11['username']?></option>
                          <?php endwhile; ?>
                      </select>
                        </div></center>
                        <br>
  ...
  <table class="table table-striped table-hover table-bordered">
    ...
    if($year=='' && $name==''){
    include "connect.php";
  echo  $strSQL2 = "SELECT * FROM leave_tbl where leader1 = '".$_SESSION['username']."' or leader2 = '".$_SESSION['username']."' or username = '".$_SESSION['username']."' and strdate like '%$year%' and status = 'approve'";
 ...
 <?php
   ...
   echo $strSQL2 = "SELECT * FROM leave_tbl Where leader1 = '".$_SESSION['username']."' or leader2 = '".$_SESSION['username']."' and strdate like '%$year%'";
   $objQuery2 = mysqli_query($objCon,$strSQL2);
...
$strSQL2 = "SELECT * FROM leave_tbl Where  username = '".$name."' and strdate like '%$year%'";
   $objQuery2 = mysqli_query($objCon,$strSQL2);
...
<?php
    ...
    $strSQL2 = "SELECT * FROM leave_tbl Where  username = '".$name."'";
   $objQuery2 = mysqli_query($objCon,$strSQL2);
