...
$token3 = "QDrULtRQWeCyeO2Gked5Rso3kyLoTheNt4GFNiuI2D4"; //ใส่Token ที่copy เอาไว้
$str3 = ."From : $from
...
$res3 = sendline($str3,$token3);
print_r($res3);
function sendline($message,$token3){
